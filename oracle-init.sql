-- OracleVision Demo Schema Init Script
-- Creates demo tables for testing OracleVision features

-- Switch to the PDB
ALTER SESSION SET CONTAINER = XEPDB1;

-- Create demo user/schema
BEGIN
    EXECUTE IMMEDIATE 'CREATE USER oraclevision IDENTIFIED BY vision123';
    EXCEPTION WHEN OTHERS THEN
        IF SQLCODE = -1920 THEN NULL; -- User already exists, ignore
        ELSE RAISE;
    END IF;
END;
/
...
GRANT CONNECT, RESOURCE TO oraclevision;
GRANT CREATE VIEW TO oraclevision;
GRANT UNLIMITED TABLESPACE TO oraclevision;
GRANT CREATE SEQUENCE TO oraclevision;

-- Set default tablespace
ALTER USER oraclevision DEFAULT TABLESPACE USERS;
ALTER USER oraclevision QUOTA UNLIMITED ON USERS;

-- Connect as the new user
ALTER SESSION SET CURRENT_SCHEMA = oraclevision;
...
CREATE TABLE customers (
    ...
    credit_limit NUMBER(10,2) DEFAULT 5000,
...
-- ============================================
-- INSERT SAMPLE DATA: PROJECT_ASSIGNMENTS
-- ============================================
...
-- Show record counts
SELECT 'Record counts:' as info FROM DUAL;
